...
import { MARVIN_PATH_IFRAME, MARVIN_EDITOR_IS_EMPTY, API } from '../config';
import { exportCml, clearEditor } from '../marvinAPI';
      ...
      if (!err) {
        ...
        exportCml()
          .then((cml) => {
            ...
            return axios.post(API.CREATE_STRUCTUSE, { data: cml, params });
          })
          .then(() => {
